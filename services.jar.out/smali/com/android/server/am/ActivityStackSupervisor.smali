...
.method static synthetic -get4(Lcom/android/server/am/ActivityStackSupervisor;)Landroid/os/IBinder;
    .locals 1
    .param p0, "-this"    # Lcom/android/server/am/ActivityStackSupervisor;
...
.method findTaskToMoveToFrontLocked(Lcom/android/server/am/TaskRecord;ILandroid/app/ActivityOptions;Ljava/lang/String;Z)V
    ...
    .local v9, "currentStack":Lcom/android/server/am/ActivityStack;
    if-nez v9, :cond_2
    ...
    const-string/jumbo v3, "findTaskToMoveToFrontLocked: can\'t move task="
    ...
    const-string/jumbo v3, " to front. Stack is null"
    ...
    invoke-virtual {p3}, Landroid/app/ActivityOptions;->getLaunchStackId()I

    move-result v1

    .local v1, "stackId":I
    invoke-virtual {p0, p3, v1}, Lcom/android/server/am/ActivityStackSupervisor;->canUseActivityOptionsLaunchBounds(Landroid/app/ActivityOptions;I)Z
    ...
    const-string/jumbo v6, "findTaskToMoveToFrontLocked"
    ...
    iget v6, v9, Lcom/android/server/am/ActivityStack;->mStackId:I
    ...
    invoke-direct/range {v2 .. v7}, Lcom/android/server/am/ActivityStackSupervisor;->handleNonResizableTaskIfNeeded(Lcom/android/server/am/TaskRecord;IIIZ)V
    ...
    :cond_7
    iget-object v6, v10, Lcom/android/server/am/ActivityRecord;->appTimeTracker:Lcom/android/server/am/AppTimeTracker;
